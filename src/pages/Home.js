...
import NewRelease from "../components/Home/NewReleaseMovies"; // Import EffectFade styles
import TopShowWatch from "../components/Home/TopShowWatch";
import PricingStrategy from "../components/Price/PricingStrategy";
import Footer from "../components/Footer";
import DownloadSection from "../components/Home/DownloadSection";
import Header from "../components/Header";
const Home = ({ setIsMobileMenuOpen }) => {
  const slidemovies = [
    {
      title: "Unlimited",
      pic: "/pro1.jpg",
  ...
  return (
    <div>
      ...
      <NewRelease setIsMobileMenuOpen={setIsMobileMenuOpen} />
      <DownloadSection />
      <TopShowWatch />
      <PricingStrategy />
      <Footer />
