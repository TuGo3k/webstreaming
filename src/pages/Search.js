...
const Search = ({ filteredMovies, search, setIsMobileMenuOpen }) => {
  return (
    <div className=" w-full h-full bg-cover bg-center -z-10 px-[5%] pt-[20%] lg:pt-[9%] pb-[25%] lg:pb-[7%]">
      <img
        className="object-cover w-full bg-cover bg-center h-full fixed top-0 left-0 -z-10"
        src="/ucm_bg02.jpg"
      ></img>
